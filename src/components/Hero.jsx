...
function Hero() {
  return (
    <section className="center white-bg gutter rounded">
      <div className="d-flex hero-container flex-column flex-lg-row my-1 w-100 h-100 gutter">
        ...
        <div className="d-flex image-container justify-center justify-lg-end w-100">
          <img
